...
function rectArea(l, w) {  return w * l;};
...
let room1 = rectArea(4, 6); let room2 = rectArea(13, 3); let room3 = rectArea(4, 8);
...
function totalRoomsArea(room1, room2, room3) {return room1 + room2 + room3;};
